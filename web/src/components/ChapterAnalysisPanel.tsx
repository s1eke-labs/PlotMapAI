import { AlertTriangle, Bot, GitBranch, Loader2, PauseCircle, Tags, Users } from 'lucide-react';
...
export default function ChapterAnalysisPanel({ novelId, analysis, job, isLoading }: ChapterAnalysisPanelProps) {

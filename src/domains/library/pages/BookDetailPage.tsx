import type { AnalysisStatusResponse } from '@domains/analysis';
...
import BookDetailActionButton, { PRIMARY_DETAIL_ACTION_CLASS } from '../components/BookDetailActionButton';
import CharacterShareChart from '../components/CharacterShareChart';
